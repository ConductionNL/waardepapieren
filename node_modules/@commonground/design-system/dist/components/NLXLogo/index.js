 ...
 */
var NLXLogo = function NLXLogo(_ref) {
  var onDark = _ref.onDark,
      props = (0, _objectWithoutProperties2["default"])(_ref, ["onDark"]);
  var color = onDark === true ? '#ffffff' : '#6C757D';
...
NLXLogo.propTypes = {
  onDark: _propTypes.bool
};
NLXLogo.defaultProps = {
  onDark: false
};
var _default = NLXLogo;
